...
const Testimonial = () => {
  return (
    <div className="text-gray-400 body-font py-14">
      <div className="container px-2 mx-auto">
        <div className="flex flex-wrap gap-6">
          {/* Testimonial 1 */}
          <div className="xl:w-1/2 lg:w-3/4 w-full px-4 py-8 border rounded-3xl">
            <div className="mx-auto text-center">
              ...
              <div className="leading-relaxed text-base inline-block">
          ...
          {/* Testimonial 2 */}
          <div className="xl:w-1/2 lg:w-3/4 py-8 border rounded-3xl">
            <div className="mx-auto text-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
