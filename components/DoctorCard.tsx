...
const DoctorCard = ({
  ...
  return (
    <div className="mobile:w-[90%] tablet:w-[45%] laptop:flex-nowrap aspect-[1.2] rounded-xl flex flex-col justify-between gap-4 bg-white cursor-pointer tablet:p-6 mobile:p-2  hover:shadow-lg font-poppins transition-all duration-200 ease-linear">
      <Image
        src={`/${img}`}
        alt="logo"
        width={700}
        height={700}
        className="w-full tablet:w-72 rounded-lg"
      />
      <div className="">
